...
function mostrarMascotasPorTipo(lista: Array<Clases.Mascota>) {
    ...
    let tabla: string = "<table class='table table-light table-hover'><thead><tr><th>Id</th><th>Nombre</th><th>Edad</th><th>Tipo</th><th>Patas</th></tr>";
...
function calcularPromedio() {
    ...
    let tipo: Clases.tipoMascota =Clases.tipoMascota[<number>$('#cmbFiltro').val()];
    ...
    mascotasFiltradas = MascotasJSON.filter(mascota => <Number>mascota.tipo === tipo);
    console.log(mascotasFiltradas);
...
function mapearCampos() {
        ...
        let tabla: string = "<table class='table table-light table-hover'><thead><tr>";
